...
var plugin = function (args) {
    ...
    function runVmafOnHoldout(args, holdout, parameterSet, policy) {
        ...
        var tonemap = (policy && policy.isHDR) ? ',tonemap=tonemap=hable:peak=0:desat=0' : '';
    ...
    if (validResults.length === 0) {
        ...
        var maxRetries = args.variables.vmafMaxRetries || 2; // Can be set by checkCQRangeRetry
        ...
        try {
            ...
            if (args.variables.vmafHoldoutSample && args.inputs.enableHoldoutValidation !== false && args.inputs.enableHoldoutValidation !== 'false') {
                ...
                if (holdoutData) {
                    ...
                    var cambiLimit = qualityRiskPolicy ? (qualityRiskPolicy.isHDR ? 4.0 : (qualityRiskPolicy.isAnimation ? 5.0 : 4.5)) : 4.5;
